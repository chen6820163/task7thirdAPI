...
/**
 * @program: task4
 * @description: 手机验证码 容联云通讯
 * @author: Mr.Chen
 * @create: 2019-04-01 00:38
 * @contact:938738637@qq.com
 **/
public class MessageUtil {

    private static  String serverIp = "ronglian.serverIp";
    private static  String serverPort = "ronglian.serverPort";
    private static  String accountSid = "ronglian.accountSid";
    private static  String accountToken = "ronglian.accountToken";
    private static  String appId = "ronglian.appId";
    /**
     * 从外部文件中初始化容联相关的配置信息
     */
    static{
    ...
    public static void main(String[] args) {
        String s = MessageUtil.sendMessage("18370402431", "11111");
